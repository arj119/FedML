...
sh run_federated_arjun_standalone_pytorch.sh 0 2 2 4 mnist ./../../../data/mnist hetero 2 3 0.03 sgd 1
#sh run_federated_arjun_standalone_pytorch.sh 0 2 2 4 shakespeare ./../../../data/shakespeare rnn hetero 1 1 0.8 sgd 1
#sh run_federated_arjun_standalone_pytorch.sh 0 2 2 4 femnist ./../../../data/FederatedEMNIST/datasets homo 1 1 0.03 sgd 1
