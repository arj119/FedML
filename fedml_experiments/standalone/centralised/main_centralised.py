...
if __name__ == "__main__":
    args, device, dataset = setup(algorithm_name='Centralised', add_custom_args=add_args)
    ...
    centralisedAPI = CentralisedAPI(dataset, device, args, client_models)
    centralisedAPI.train()
