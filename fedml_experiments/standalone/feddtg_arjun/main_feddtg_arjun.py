...
if __name__ == "__main__":
    args, device, dataset = setup(algorithm_name='FedDTG_Arjun', add_custom_args=add_args)
    ...
    feddtgarjunAPI = FedDTGArjunAPI(dataset, device, args, generator, client_models)
    feddtgarjunAPI.train()
