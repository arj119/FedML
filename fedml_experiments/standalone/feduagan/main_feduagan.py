...
from fedml_api.standalone.federated_uagan.server import FedUAGANAPI
...
if __name__ == "__main__":
    args, device, dataset = setup(algorithm_name='FedUAGAN', add_custom_args=add_args)
    ...
    feduaganAPI = FedUAGANAPI(dataset, device, args, adapter_model, client_models)
    feduaganAPI.train()
